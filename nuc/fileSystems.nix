...
{
  fileSystems = {
    "multimedia1" = mkMount { name = "multimedia"; uuid = "C6B89CABB89C9B8D"; };

    "multimedia2" = mkMount { name = "multimedia2"; uuid = "9E167A141679EE21"; };

    "backups" = mkMount { name = "backups"; uuid = "AADEEA03DEE9C7A1"; };
  };
}
