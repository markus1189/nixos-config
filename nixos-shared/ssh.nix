...

{
  ...
  users.users.${config.my.userName}.openssh.authorizedKeys.keys = [
    ...
    "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIOnrif83vV1qiqX6n2hXXIRCkOjFVQJxA7gzD7/IddXW markus+2026@p1g8"
    "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIGiZJcsZSI9w+ii207uVPuu0SOpSL2DjF/fAhHOwTAtI termius-mobile"
  ];
}
