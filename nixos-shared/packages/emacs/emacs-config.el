  ...
  (setq elfeed-feeds
        (append
         (let ((serverUrl "http://localhost:9999"))
           (mapcar
            ...
            '((:subreddit "ExperiencedDevs")
              ...
              (:subreddit "emacs" :tags (programming))
              (:subreddit "esp32")
              ...
              (:subreddit "haskell" :tags (programming))
         ...
         '(("https://liore.com/rss/")
           ...
           ("https://www.ivanseymus.com/feed/" analog)
           ...
           ("https://cosmiccoding.com.au/index.xml" programming)
