         ...
         (mapcar
          ...
          (seq-filter
           ...
           '((:channelId "UCl_5s2WDFi38LiXUQA7CTWQ" :title "Chris Kaula" :disabled t)
             ...
             (:channelId "UC8szqVDJF60HueoqJrD50qw" :title "GOLDEN TRAIL SERIES" :tags (sport running-trail))
             ...
             (:channelId "UCbBVRJq3H6yRvC9G6xBLJZw" :title "UTMB World Series" :tags (sport running-trail))
