...
Provides more detailed messages on failure."
  ...
  (defface mh/elfeed-outsideonline-tag-face
    '((t :foreground "#FD8"))
    "Marks Outside Online tags.")
  (defface mh/elfeed-hackaday-tag-face
    '((t :foreground "#888"))
    "Marks Hackaday tags.")
  (defface mh/elfeed-quarks-tag-face
    '((t :foreground "#ADF"))
    "Marks quarks.de tags.")
  (defface mh/elfeed-haskell-discourse-tag-face
    '((t :foreground "#79F"))
    "Marks Haskell Community tags.")
  (defface mh/elfeed-haskell-fp-tag-face
    '((t :foreground "#B8F"))
    "Marks Haskell/FP programming tags.")
  (defface mh/elfeed-emacs-dev-tag-face
    '((t :foreground "#CAE"))
    "Marks Emacs development tags.")
  (defface mh/elfeed-programming-general-tag-face
    '((t :foreground "#89C"))
    "Marks general programming tags.")
  (defface mh/elfeed-pens-stationery-tag-face
    '((t :foreground "#DA6"))
    "Marks pens and stationery tags.")
  (defface mh/elfeed-journals-bujo-tag-face
    '((t :foreground "#B86"))
    "Marks journals and bullet journal tags.")
  (defface mh/elfeed-analog-general-tag-face
    '((t :foreground "#DB9"))
    "Marks general analog tags.")
  (defface mh/elfeed-running-trail-tag-face
    '((t :foreground "#F96"))
    "Marks running and trail running tags.")
  (defface mh/elfeed-cycling-zwift-tag-face
    '((t :foreground "#3CF"))
    "Marks cycling and Zwift tags.")
  (defface mh/elfeed-sport-general-tag-face
    '((t :foreground "#6C6"))
    "Marks general sport tags.")
  ...
  (setq elfeed-search-face-alist '((unread elfeed-search-unread-title-face)
                                   ...
                                   (outsideonline mh/elfeed-outsideonline-tag-face)
                                   (hackaday mh/elfeed-hackaday-tag-face)
                                   (quarks mh/elfeed-quarks-tag-face)
                                   (haskell-discourse mh/elfeed-haskell-discourse-tag-face)
                                   (haskell-fp mh/elfeed-haskell-fp-tag-face)
                                   (emacs-dev mh/elfeed-emacs-dev-tag-face)
                                   (programming-general mh/elfeed-programming-general-tag-face)
                                   (pens-stationery mh/elfeed-pens-stationery-tag-face)
                                   (journals-bujo mh/elfeed-journals-bujo-tag-face)
                                   (analog-general mh/elfeed-analog-general-tag-face)
                                   (running-trail mh/elfeed-running-trail-tag-face)
                                   (cycling-zwift mh/elfeed-cycling-zwift-tag-face)
                                   (sport-general mh/elfeed-sport-general-tag-face)))
        ...
        (append
         (let ((serverUrl "http://localhost:9999"))
           (mapcar
            ...
            '((:subreddit "ExperiencedDevs")
              (:subreddit "AdvancedRunning" :tags (sport running-trail))
              (:subreddit "books" :tags (reading))
              (:subreddit "booksuggestions" :tags (reading))
              (:subreddit "bulletjournal" :tags (analog journals-bujo))
              (:subreddit "claudeai" :tags (llm))
              (:subreddit "claudecode" :tags (llm))
              (:subreddit "codex" :tags (llm))
              (:subreddit "commandline")
              (:subreddit "compsci")
              (:subreddit "cycling" :tags (sport cycling-zwift))
              (:subreddit "deepseek" :tags (llm))
              (:subreddit "electronics")
              (:subreddit "emacs" :tags (programming emacs-dev))
              (:subreddit "esp32")
              ...
              (:subreddit "githubcopilot" :tags (llm))
              (:subreddit "gridfinity" :threshold 90)
              (:subreddit "haskell" :tags (programming haskell-fp))
              (:subreddit "internetisbeautiful")
              (:subreddit "ironsworn")
              (:subreddit "litrpg")
              (:subreddit "malazan")
              (:subreddit "netsec")
              (:subreddit "nixos" :tags (programming programming-general))
              (:subreddit "notebooks" :tags (analog journals-bujo))
              (:subreddit "NoteTaking" :tags (analog journals-bujo))
              (:subreddit "oneui")
              (:subreddit "openrouter" :tags (llm))
              (:subreddit "osr")
              ...
              (:subreddit "tools")
              (:subreddit "trailrunning" :tags (sport running-trail))
              (:subreddit "ultramarathon" :tags (sport running-trail))
              (:subreddit "traveller")
              (:subreddit "ultrarunning" :tags (sport running-trail))
              (:subreddit "usbchardware")
              (:subreddit "usenet")
              (:subreddit "worldnews" :threshold 70)
              (:subreddit "writingprompts" :threshold 80)
              (:subreddit "wwn")
              (:subreddit "zwift" :tags (sport cycling-zwift))
              (:subreddit "ai_agents"))))
         ...
         (mapcar
          ...
          (seq-filter
           ...
           '((:channelId "UCl_5s2WDFi38LiXUQA7CTWQ" :title "Chris Kaula" :disabled t)
             ...
             (:channelId "UCHMfbHsJZCqRtSCVLV-RnYA" :title "Daily MTB Rider" :tags (sport sport-general))
             ...
             (:channelId "UCRHCA0iiOZ_tbOowedaeK-A" :title "Skyrunning Federation" :tags (sport running-trail))
             ...
             (:channelId "UCIfRR1N2Gm1vjj9X955iWSQ" :title "NorCal Cycling" :tags (sport cycling-zwift))
             ...
             (:channelId "UCqZQlzSHbVJrwrn5XvzrzcA" :title "NBC Sports" :tags (sport sport-general))
             (:channelId "UCSoOJTknGqXQSeamRjEE8aA" :title "TechDregs")
             (:channelId "UCNQJqvSXfDBOd9spve8doWw" :title "Worm Girl CDDA")
             (:channelId "UCt1ES-_FMXQfM3JeO_FrOXw" :title "ParkNotes" :tags (analog journals-bujo))
             ...
             (:channelId "UCUwGYfvGvmqMnvQTOY8E_qg" :title "Göran Winblad - Running" :tags (sport running-trail))
             ...
             (:channelId "UCw7R5moYo-DNLw4BKjFX3bg" :title "Bradford Redpath Zwift Racing" :tags (sport cycling-zwift))
             ...
             (:channelId "UCvOR_jzp6_8jP4Q68A-UkXw" :title "Michi Wohlleben" :tags (sport))
             ...
             (:channelId "UCb3KwY6oUqATTRQa4m4fIDw" :title "Eric Hanson" :tags (sport)))))
         ...
         (mapcar
          ...
          '((:id "bgfqc0awgchwumud" :title "Bike Components")
            ...
            (:id "6q589fdch91df178bb53" :title "GraphicAudio" :tags (audiobooks))
            (:id "y1tyyjh3rwdk1ee62g6a" :title "ktn")))
         ...
         '(("requesty:blog" llm)
           ...
           ("https://jamierubin.net/feed/" analog journals-bujo)
           ("https://fromthepencup.wordpress.com/feed/" analog journals-bujo)
           ("https://semi-rad.com/feed/" sport running-trail)
           ("https://www.irunfar.com/feed" sport running-trail)
           ("https://www.quarks.de/feed/" quarks)
           ("https://www.geo.de/feed/rss/geo/")
           ("https://xc-run.de/feed/" sport running-trail)
           ("https://sabbatical.derfred.org?feed=rss2")
           ("https://kimi-schreiber.de/feed/")
           ("https://www.ivanseymus.com/feed/" analog analog-general)
           ("https://buttondown.com/cassidoo/rss")
           ("https://buttondown.email/hillelwayne/rss")
           ("https://terminaltrove.com/totw.xml" programming programming-general)
           ("https://perishablepress.com/feed/atom/")
           ("https://registerspill.thorstenball.com/feed" programming)
           ("https://piccalil.li/articles.xml")
           ("https://www.raptitude.com/feed/")
           ("https://rss.p.theconnman.com/r/netbrain/zwift")
           ("https://jillianhess.substack.com/feed" analog analog-general)
           ...
           ("https://forums.zwift.com/top.rss" sport cycling-zwift)
           ...
           ("https://rediscoveranalog.com/feed" analog analog-general)
           ("https://www.wellappointeddesk.com/feed" analog pens-stationery)
           ("https://thepoorpenman.com/feed" analog pens-stationery)
           ...
           ("https://www.dcrainmaker.com/feed/" sport running-trail)
           ("https://embracethered.com/blog/index.xml")
           ("https://ennie-awards.com/feed")
           ("https://hk-newsletter.de/feed" news)
           ("https://hofheim-news.de/feed/" news)
           ("https://feeds.feedburner.com/AnnaHavron")
           ("https://analogfromhere.com/feed/" analog analog-general)
           ("https://analogoffice.net/feed.xml")
           ("https://seb.jambor.dev/feed.xml")
           ("https://bulletjournal.com/blogs/bulletjournalist.xml" analog journals-bujo)
           ("https://blog.pragmaticengineer.com/feed/")
           ("https://www.trailandkale.com/feed/" sport running-trail)
           ("https://www.takenote.space/blog-posts?format=rss" analog journals-bujo)
           ("https://www.rennrad-news.de/news/rss" sport cycling-zwift)
           ...
           ("https://www.mountainofink.com/?format=rss" analog pens-stationery)
           ...
           ("https://nixos.org/blog/feed.xml" programming programming-general)
           ...
           ("https://www.penaddict.com/blog?format=rss" analog pens-stationery)
           ...
           ("https://www.commandlinefu.com/feed/tenup" programming programming-general)
           ("https://www.haskellforall.com/feeds/posts/default" programming haskell-fp)
           ("https://byorgey.github.io/blog/rss.xml" programming haskell-fp)
           ("https://byorgey.wordpress.com/feed/" programming haskell-fp)
           ("https://planet.haskell.org/rss20.xml" programming haskell-fp)
           ("https://feeds2.feedburner.com/catonmat")
           ("https://themonadreader.wordpress.com/feed/" programming haskell-fp)
           ("https://irreal.org/blog/?feed=rss2" programming emacs-dev)
           ("https://www.haskellcast.com/feed.xml" programming haskell-fp)
           ("https://jvns.ca/atom.xml" programming programming-general)
           ("https://sachachua.com/blog/feed/" programming emacs-dev)
           ...
           ("https://jaspervdj.be/rss.xml" programming haskell-fp)
           ("https://joeyh.name/blog/index.rss")
           ("https://funktionale-programmierung.de/rss.xml" programming haskell-fp)
           ("https://okmij.org/ftp/rss.xml")
           ("https://oliveoctopus.ink/rss.xml" analog pens-stationery)
           ("https://openai.com/news/rss.xml" llm)
           ...
           ("https://feeds.feedburner.com/NotebookStories" analog analog-general)
           ("https://meta.plasm.us/atom.xml")
           ...
           ("https://daniel.haxx.se/blog/feed/" programming programming-general)
           ("https://wearetrailmix.substack.com/feed" sport running-trail)
           ...
           ("https://varoa.net/feed.xml" programming programming-general)
           ("https://www.geoffreylitt.com/feed.xml" programming programming-general)
           ("https://www.gleech.org/feed.xml")
           ("https://jmswrnr.com/feed" hacking)
           ("https://terminaltrove.com/blog.xml" programming programming-general)
           ...
           ("https://code.claude.com/docs/en/whats-new/rss.xml" llm programming programming-general)
